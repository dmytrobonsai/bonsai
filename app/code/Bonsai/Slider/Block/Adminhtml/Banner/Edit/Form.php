...
namespace Bonsai\Slider\Block\Adminhtml\Banner\Edit;
...
class Form extends \Magento\Backend\Block\Widget\Form\Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        $banner = $this->_coreRegistry->registry('bonsai_slider_banner');
        ...
        $bannerData = $this->_session->getData('bonsai_slider_banner_data', true);
        if ($bannerData) {
