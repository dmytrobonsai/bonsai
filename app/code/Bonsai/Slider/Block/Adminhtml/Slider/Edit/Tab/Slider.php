...
class Slider extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
     ...
     * Status options
     *
     * @var \Bonsai\Slider\Model\Slider\Source\Status
     */
    protected $_statusOptions;

    /**
     * @var \Bonsai\Slider\Model\Slider\Source\Animation
     */
     ...
     * constructor
     *
     * @param \Bonsai\Slider\Model\Slider\Source\Status $_statusOptions
     * @param \Bonsai\Slider\Model\Slider\Source\Animation $_animationOptions
    ...
    public function __construct(
        \Bonsai\Slider\Model\Slider\Source\Status $_statusOptions,
        \Bonsai\Slider\Model\Slider\Source\Animation $_animationOptions,
    ...
    protected function _prepareForm()
    {
        ...
        $slider = $this->_coreRegistry->registry('bonsai_slider_slider');
        ...
        $sliderData = $this->_session->getData('bonsai_slider_slider_data', true);
        if ($sliderData) {
