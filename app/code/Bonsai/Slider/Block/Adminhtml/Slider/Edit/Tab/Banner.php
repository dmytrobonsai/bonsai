...
namespace Bonsai\Slider\Block\Adminhtml\Slider\Edit\Tab;
...
class Banner extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var \Bonsai\Slider\Model\ResourceModel\Banner\Collection $collection */
        ...
        $collection->getSelect()->joinLeft(
            ['related' => $collection->getTable('bonsai_slider_banner_slider')],
    ...
    /**
     * @param \Bonsai\Slider\Model\Banner|\Magento\Framework\Object $item
     * @return string
     */
    ...
    {
        return $this->coreRegistry->registry('bonsai_slider_slider');
    }
    ...
    {
        return $this->getUrl('bonsai_slider/slider/banners', ['_current' => true]);
    }
