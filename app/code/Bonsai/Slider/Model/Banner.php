...
class Banner extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'bonsai_slider_banner';
     ...
     * @var string
     */
    protected $_cacheTag = 'bonsai_slider_banner';
     ...
     * @var string
     */
    protected $_eventPrefix = 'bonsai_slider_banner';

    /**
     * Slider Collection
     *
     * @var \Bonsai\Slider\Model\ResourceModel\Slider\Collection
     */
     ...
     * constructor
     *
     * @param \Bonsai\Slider\Model\ResourceModel\Slider\CollectionFactory $sliderCollectionFactory
    ...
    public function __construct(
        \Bonsai\Slider\Model\ResourceModel\Slider\CollectionFactory $sliderCollectionFactory,
    ...
    {
        $this->_init('Bonsai\Slider\Model\ResourceModel\Banner');
    }
    ...
    /**
     * @return \Bonsai\Slider\Model\ResourceModel\Slider\Collection
     */
    public function getSelectedSlidersCollection()
    {
        if (is_null($this->sliderCollection)) {
            ...
            $collection->join(
                ...
                'main_table.slider_id=bonsai_slider_banner_slider.slider_id AND bonsai_slider_banner_slider.banner_id='.$this->getId(),
                ['position']
            );
