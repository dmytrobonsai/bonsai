...
class Slider extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'bonsai_slider_slider';
     ...
     * @var string
     */
    protected $_cacheTag = 'bonsai_slider_slider';
     ...
     * @var string
     */
    protected $_eventPrefix = 'bonsai_slider_slider';

    /**
     * Banner Collection
     *
     * @var \Bonsai\Slider\Model\ResourceModel\Banner\Collection
     */
     ...
     *
     * @var \Bonsai\Slider\Model\ResourceModel\Banner\CollectionFactory
     */
     ...
     * constructor
     *
     * @param \Bonsai\Slider\Model\ResourceModel\Banner\CollectionFactory $bannerCollectionFactory
    ...
    public function __construct(
        \Bonsai\Slider\Model\ResourceModel\Banner\CollectionFactory $bannerCollectionFactory,
    ...
    {
        $this->_init('Bonsai\Slider\Model\ResourceModel\Slider');
    }
    ...
    /**
     * @return \Bonsai\Slider\Model\ResourceModel\Banner\Collection
     */
    public function getSelectedBannersCollection()
    {
        if (is_null($this->bannerCollection)) {
            ...
            $collection->join(
                'bonsai_slider_banner_slider',
                'main_table.banner_id=bonsai_slider_banner_slider.banner_id AND bonsai_slider_banner_slider.slider_id=' . $this->getId(),
                ['position']
            );
