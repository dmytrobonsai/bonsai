...
namespace Bonsai\Slider\Model\ResourceModel;
...
class Banner extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    public function __construct(
        ...
        $this->bannerSliderTable = $this->getTable('bonsai_slider_banner_slider');
    }
    ...
    {
        $this->_init('bonsai_slider_banner', 'banner_id');
    }
     ...
     *
     * @param \Magento\Framework\Model\AbstractModel|\Bonsai\Slider\Model\Banner $object
     * @return $this
     */
    ...
    /**
     * @param \Bonsai\Slider\Model\Banner $banner
     * @return array
     */
    public function getSlidersPosition(\Bonsai\Slider\Model\Banner $banner)
    {
     ...
     * @return $this
     */
    protected function saveSliderRelation(\Bonsai\Slider\Model\Banner $banner)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'bonsai_slider_banner_change_sliders',
