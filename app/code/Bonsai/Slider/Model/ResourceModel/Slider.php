...
class Slider extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    public function __construct(
        ...
        $this->sliderBannerTable = $this->getTable('bonsai_slider_banner_slider');
    }
    ...
    {
        $this->_init('bonsai_slider_slider', 'slider_id');
    }
     ...
     *
     * @param \Magento\Framework\Model\AbstractModel|\Bonsai\Slider\Model\Slider $object
     * @return $this
     */
    ...
    /**
     * @param \Bonsai\Slider\Model\Slider $slider
     * @return array
     */
    public function getBannersPosition(\Bonsai\Slider\Model\Slider $slider)
    {
     ...
     * @return $this
     */
    protected function saveBannerRelation(\Bonsai\Slider\Model\Slider $slider)
    {
        ...
        if (!empty($insert) || !empty($delete)) {
            ...
            $this->eventManager->dispatch(
                'bonsai_slider_slider_change_banners',
