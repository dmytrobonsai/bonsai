...
class Edit extends \Bonsai\Slider\Controller\Adminhtml\Banner
{
    ...
    {
        return $this->_authorization->isAllowed('Bonsai_Slider::banner');
    }
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Bonsai_Slider::banner');
        ...
        $data = $this->_session->getData('bonsai_slider_banner_data', true);
        if (!empty($data)) {
            $banner->setData($data);
        }
        return $resultPage;
