...
class Edit extends \Bonsai\Slider\Controller\Adminhtml\Slider
{
    ...
    {
        return $this->_authorization->isAllowed('Bonsai_Slider::slider');
    }
    ...
    public function execute()
    {
        ...
        $resultPage->setActiveMenu('Bonsai_Slider::slider');
        ...
        $data = $this->_session->getData('bonsai_slider_slider_data', true);
        if (!empty($data)) {
            $slider->setData($data);
        }
        return $resultPage;
